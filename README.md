## Telegram_Relational_DB_Case_Study
...
* Include triggers and stored procedures.
* Extend the schema for Telegram Premium features.
* Develop a web-based database interface.
